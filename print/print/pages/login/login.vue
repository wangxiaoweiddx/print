	...
	<view class="loginWrap ">
		...
		<form v-if="loginWay == '短信验证登录'" class="loginForm" @submit="formSubmit">
			<view class="uni-form-item uni-column">
				<u--input placeholder="请输入登录账号" v-model="value" type="number" clearable></u--input>
			</view>
			<view class="uni-form-item uni-column">
				<u--input v-model="value" type="password"  password-icon="true"></u--input>
		...
		<u-form class="loginForm" v-if="loginWay == '账号密码登录'" :model="form" ref="uForm">
			<view class="uni-form-item uni-column">
				<u--input placeholder="请输入手机号码" type="number" v-model="form.name"></u--input>
			</view>
			<view class="uni-form-item uni-column">
				<u--input placeholder="请输入验证码" v-model="form.name"></u--input>
				<view class="wrap">
